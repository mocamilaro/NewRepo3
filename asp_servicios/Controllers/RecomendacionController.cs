...
namespace asp_servicios.Controllers
{
    ...
    {
        private IRecomendacionAplicacion? iAplicacion = null;
        private TokenController? tokenController = null;

        public RecomendacionController(IRecomendacionAplicacion? iAplicacion,
        ...
        public string Buscar()
        {
            ...
            try
            {
                ...
                var entidad = JsonConversor.ConvertirAObjeto<Recomendacion>(
