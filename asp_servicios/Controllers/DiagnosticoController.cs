...
namespace asp_servicios.Controllers
{
    ...
    {
        private IDiagnosticoAplicacion? iAplicacion = null;
        private TokenController? tokenController = null;

        public DiagnosticoController(IDiagnosticoAplicacion? iAplicacion,
        ...
        public string Buscar()
        {
            ...
            try
            {
                ...
                var entidad = JsonConversor.ConvertirAObjeto<Diagnostico>(
